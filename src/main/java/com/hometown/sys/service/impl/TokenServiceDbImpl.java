...
import com.hometown.dto.Token;
import com.hometown.model.TokenModel;
import com.hometown.sys.dao.TokenDao;
import com.hometown.sys.service.SysLogService;
import com.hometown.sys.service.TokenService;
...
public class TokenServiceDbImpl implements TokenService {
	...
	private Key getKeyInstance() {
		if (KEY == null) {
			synchronized (com.hometown.sys.service.impl.TokenServiceDbImpl.class) {
				if (KEY == null) {// 双重锁
